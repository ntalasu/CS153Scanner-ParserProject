...
public class Node
{
    ...
    {
        PROGRAM, COMPOUND, ASSIGN, LOOP, TEST, WRITE, WRITELN, NOT, IF,
        ADD, SUBTRACT, MULTIPLY, DIVIDE, EQ, LT, LE, GT, NEGATE, NE, GE,
        VARIABLE, INTEGER_CONSTANT, REAL_CONSTANT, STRING_CONSTANT,
        SELECT, SELECT_BRANCH, SELECT_CONSTANTS, AND, OR, INTEGER_DIVIDE
    }
